...
public abstract class InfoDictionary {
    ...
    private String name;
    /*
     * (optional) If it is set to "1", the es.deusto.ssdd.client MUST publish its presence to get other peers ONLY
     * via the trackers explicitly described in the metainfo file. If this field is set to "0" or
     * is not present, the es.deusto.ssdd.client may obtain peer from other means, e.g. peer exchange.
     */
